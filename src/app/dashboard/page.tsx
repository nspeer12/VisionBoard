...
import { Sparkles, BookOpen, ArrowRight, LayoutGrid, Plus, Home } from "lucide-react";
    ...
    <main className="min-h-screen bg-gradient-warm">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        ...
        {journals.length > 0 && (
          ...
          >
            <div className="prompt-card p-5 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-serif text-sm sm:text-base text-slate mb-4 sm:mb-6">
                    Continue where you left off or revisit a previous journal.
                  </p>
